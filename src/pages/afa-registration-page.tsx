        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-1">Create AFA registration orders</p>
            </div>
          ...
          <div className="max-w-2xl mx-auto">
            <Card className="shadow-lg">
              <CardBody className="p-6 sm:p-8">
                                 <div className="mb-6 sm:mb-8">
                   <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Create AFA Registration</h2>
                   <p className="text-gray-600 text-sm sm:text-base">Enter customer details to create an AFA registration order.</p>
                 </div>
          ...
          <div className="max-w-6xl mx-auto">
            <Card className="shadow-lg">
              <CardBody className="p-6">
                <div className="mb-6">
                  <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">AFA Registration Orders</h2>
                  <p className="text-gray-600 text-sm sm:text-base">View all your AFA registration orders</p>
                </div>

                {afaOrders.length === 0 ? (
                  <div className="text-center py-8">
                    <p className="text-gray-500">No AFA registration orders found.</p>
                  </div>
                ) : (
